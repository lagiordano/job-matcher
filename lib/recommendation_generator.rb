...
class RecommendationGenerator
    ...
    def recommendation_list
        ...
        puts "\nFirstly, Lauren Giordano is the number one recommendation for ReadyTech's Junior Rails Engineer position! Please see below for a list of our other job-jobseeker recommendations:"
